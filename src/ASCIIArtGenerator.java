...
public class ASCIIArtGenerator {
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println();
        artGen.printTextArt("Love is life!", ASCIIArtGenerator.ART_SIZE_SMALL, ASCIIArtFont.ART_FONT_SANS_SERIF,"@");
        System.out.println();       
        
        System.out.println();
        artGen.printTextArt("Love is life!", ASCIIArtGenerator.ART_SIZE_SMALL, ASCIIArtFont.ART_FONT_SERIF,"*");
        System.out.println();           
